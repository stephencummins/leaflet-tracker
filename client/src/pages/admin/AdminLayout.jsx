    ...
    <div className="admin-layout">
      <aside className="admin-sidebar">
        ...
        <nav className="admin-nav">
          ...
          <NavLink to="/admin/rounds" className={({ isActive }) => `admin-nav-link ${isActive ? 'active' : ''}`}>
            Rounds
          </NavLink>
          <NavLink to="/admin/candidates" className={({ isActive }) => `admin-nav-link ${isActive ? 'active' : ''}`}>
            Candidates
          </NavLink>
          <NavLink to="/admin/postal-votes" className={({ isActive }) => `admin-nav-link ${isActive ? 'active' : ''}`}>
            Postal Votes
          </NavLink>
          ...
          <NavLink to="/admin/proposers" className={({ isActive }) => `admin-nav-link ${isActive ? 'active' : ''}`}>
            Proposers
          </NavLink>
